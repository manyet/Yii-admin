...
<form id="form" method="POST" action="<?=\yii\helpers\Url::toRoute('edit')?>" data-validate data-ajax="true" onSubmit="return false;">
<div class="clearfix">
	<div class="col-lg-6">
	...
	<div class="col-lg-6">
		<div class="callout" style="border: 1px solid #d2d6de">
			<h4>支持参数 <small>手动输入或点击参数复制，邮件标题、邮件内容均支持下列参数</small></h4>
			<p>
	...
	<div class="col-lg-6">
		...
		<div class="form-group">
			<label>中文邮件内容</label>
			<textarea name="content" style="height: 300px;width: 100%"><?= $row['content'] ?></textarea>
		</div>
	</div>
	<div class="col-lg-6">
		<div class="form-group">
			<label>英文邮件标题</label>
			<input type="text" name="eng_title" class="form-control" value="<?= $row['eng_title'] ?>"/>
		</div>
		<div class="form-group">
			<label>英文邮件内容</label>
			<textarea name="eng_content" style="height: 300px;width: 100%"><?= $row['eng_content'] ?></textarea>
		</div>
	</div>
</div>
