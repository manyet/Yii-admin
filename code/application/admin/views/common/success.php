...
<body class="sidebar-mini">
	<section class="content">
      ...
      <div class="error-page">
        <h2 class="headline text-success">200</h2>

        <div class="error-content">
          <h3><i class="fa fa-success text-red"></i> 操作成功！</h3>

          <p>
			<h2><?= nl2br(Html::encode($message)) ?></h2>
            你可以 <a href="<?= \yii\helpers\Url::home() ?>">返回首页</a> 或 <a href="javascript:history.back();">返回上一页</a>
			<p class="f-fs14 fc-999 f-mt5">页面 <span id="wait" class="fc-f40"><?= $waitSecond ?></span> 秒后自动 <a id="href" class="fc-0e6a99" href="<?= $jumpUrl ?>">跳转</a></p>
          </p>
