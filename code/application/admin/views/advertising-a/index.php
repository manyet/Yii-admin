...
<div class="callout callout-info">
	<h4>广告位描述</h4>
	<p>MESPC广告位A为首页顶部轮播图广告位，位于电脑端首页&手机端首页顶部，可点击右侧‘位置图览’进行位置查看。建议该广告位数不超过6位，电脑广告图建议尺寸1900 x 730（建议每张图比例一样），手机广告图建议尺寸750 x 290，支持格式JPG、PNG，可预览后再做发布处理。</p>
</div>
<?php $this->endBlock() ?>
...
<form class="form-inline" role="form"
	...
	<div class="form-group pull-right">
		<button type="button" class="btn btn-sm btn-default" data-thumb="<?= get_img_url('advertising-a.jpeg') ?>" data-max-width="1000">位置图览</button>
		<?php if (checkAuth('advertising-a/add')) { ?>
		<button type="button" class="btn btn-sm btn-success" data-href="<?=\yii\helpers\Url::toRoute('advertising-a/add') ?>"><i class="fa fa-plus"></i>&nbsp;新增广告组</button>
		<?php } ?>
	</div>
</form>
...
//    'checkbox' => 'ids',//$.table.getChecked();拿到选中
	...
	'operations' => array(
        array('key' => 'id', 'text' => '编辑', 'js' => 'getHrefButton', 'path' => 'advertising-a/add'),
        array('key' => 'open', 'js' => 'getReleaseButton', 'path' => 'advertising-a/release'),
		array('key' => 'id', 'text' => '删除', 'js' => 'getDelButton', 'path' => 'advertising-a/del')
	),
	'list' => $list
]) ?>
<?php $this->endBlock() ?>
