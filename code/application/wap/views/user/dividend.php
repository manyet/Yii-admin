...
$this->title = Yii::t('app', 'wallet_company_bonus');
?>
<?php $this->beginBlock('header') ?>
<a href="<?= Url::toRoute('user/index') ?>" class="back"></a>
<h2 class="f-fs16 fc-fff"><?= Yii::t('app', 'wallet_company_bonus') ?></h2>
<?php $this->endBlock() ?>
...
<div class="limit-size">
	<div class="top_div">
		<div class="fc-fff f-fs14 bg-c32545 f-pt15 f-pb15 f-tc limit-size">
			...
			<div class="f-fs22 f-mt10 f-mb5"><?= number_format($user_info['company_dividend'], 2) ?></div>
		</div>
	</div>
	...
	<div class="bottom_div">
		<div class="f-tc limit-size">
			<a href="<?= Url::toRoute(['withdraw/index', 'id' => '2'])?>" class="f-w100 btn btn_yellow f-db fc-333 f-fwb f-fs16"><?=Yii::t('app','withdraw_bank_presentation')?></a>
		</div>
	</div>
	<!--底部开始-->
...
function pullupRefresh(isRefresh) {
	$.http.get('<?= \yii\helpers\Url::toRoute('get-dividend-list') ?>', {page: page, rows: rows}, {
		before: function() {
