...
$this->title = Yii::t('app', 'wallet_cash_score');
?>
<?php $this->beginBlock('header') ?>
<a href="<?= Url::toRoute('user/index') ?>" class="back"></a>
<h2 class="f-fs16 fc-fff"><?= Yii::t('app', 'wallet_cash_score') ?></h2>
<?php $this->endBlock() ?>
...
<div class="limit-size">
	<div class="top_div">
		<div class="fc-fff f-fs14 bg-c32545 f-pt15 f-pb15 f-tc limit-size">
			...
			<div class="f-fs22 f-mt10 f-mb5"><?= number_format($user_info['cash_integral'], 2) ?></div>
		</div>
	</div>
	...
	<div class="bottom_div">
		<div class="f-tc limit-size clearfix">
			<a href="<?= Url::toRoute(['withdraw/index', 'id' => '1'])?>" class="f-w50 f-fl btn btn_yellow f-dib fc-333 f-fwb f-fs16"><?=Yii::t('app','withdraw_bank_presentation')?></a>
			<a href="<?= Url::toRoute(['transfer', 'id' => '2'])?>" class="f-w50 f-fl btn btn_yellowD f-dib fc-333 f-fwb f-fs16"><?=Yii::t('app','transfer')?></a>
		</div>
	</div>
	<!--底部开始-->
</div>
...
function pullupRefresh(isRefresh) {
	$.http.get('<?= \yii\helpers\Url::toRoute('get-cash-list') ?>', {page: page, rows: rows}, {
		before: function() {
