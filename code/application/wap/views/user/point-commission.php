...
$this->title = Yii::t('app', 'commission_point_award');
?>
<?php $this->beginBlock('header') ?>
<a href="<?= Url::toRoute('user/index') ?>" class="back"></a>
<h2 class="f-fs16 fc-fff"><?= Yii::t('app', 'commission_point_award') ?></h2>
<?php $this->endBlock() ?>
...
<div class="limit-size">
	<div class="top_div">
		<div class="fc-fff f-fs14 bg-c32545 f-pt15 f-pb15 f-tc limit-size">
			...
			<div class="f-fs22 f-mt10 f-mb5"><?= number_format($user_info['total_point_reward'], 2) ?></div>
		</div>
	</div>
...
function pullupRefresh(isRefresh) {
	$.http.get('<?= \yii\helpers\Url::toRoute('point-commission-list') ?>', {page: page, rows: rows}, {
		before: function() {
