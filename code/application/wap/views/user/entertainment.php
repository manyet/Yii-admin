...
$this->title = Yii::t('app', 'wallet_entertainment_score');
?>
<?php $this->beginBlock('header') ?>
<a href="<?= Url::toRoute('user/index') ?>" class="back"></a>
<h2 class="f-fs16 fc-fff"><?= Yii::t('app', 'wallet_entertainment_score') ?></h2>
<?php $this->endBlock() ?>
...
<div class="limit-size">
	...
	<div class="bottom_div">
		<div class="f-tc limit-size">
			<a href="<?= Url::toRoute(['transfer', 'id' => '3'])?>" class="f-w100 btn btn_yellow f-db fc-333 f-fwb f-fs16"><?=Yii::t('app','transfer')?></a>
		</div>
	</div>
	<!--底部开始-->
</div>
...
function pullupRefresh(isRefresh) {
	$.http.get('<?= \yii\helpers\Url::toRoute('get-entertainment-list') ?>', {page: page, rows: rows}, {
		before: function() {
