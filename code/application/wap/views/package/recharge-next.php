...
<div class="limit-size">
	<ul class="fc-fff f-fs14 f-pl10 f-pr10 bg-bd0a2e f-mt10">
		...
		<li class="clearfix bordtot-890625 f-ptb8">
			<span class="fc-f5ce7f"><?= Yii::t('app', 'this_recharge_time_get', ['score' => Yii::t('app', 'package_froze_electron')]) ?></span>
			<span class="f-fr"><?= number_format($total * $user_info['electron_multiple'], 2) ?></span>
		</li>
	</ul>
	<form method="post" data-ajax data-validate action="<?= Url::toRoute('recharge') ?>">
		...
		<div class="f-pl10 f-pr10">
			<button class="btn btn_yellow f-w100 f-fs16 f-pt10 f-pb10 fc-333 f-fwb f-br5 f-mt20"><?= Yii::t('app', 'confirm_recharge')?></button>
		</div>
    </form>
</div>
<?php $this->endBlock() ?>
